...
# Command sig_dF_F_activity, sig_dF_F_coactivity_threshold, sig_dF_F_coactivity_peaks = findSignificantDF_FCoactivity(CALCIUM_FLUORESCENCE_mat['calcium_fluorescence']['dF_F']);
# CFPD(ZEBRAFISH-9DPF_CALCIUM-FLUORESCENCE Processing data) data 160 * 8194
...
def findSignificantDF_FCoactivity(dF_F):
    ...
    # \_ CONST['STD_SIG_THRESHOLD']: dF/F-signal significance level in standard = 2
...
if __name__ == "__main__":
    # ********************************************************************************
    # Argument parsing
    # COMMAND: python SGC.py preprocessing /path/to/*_CALCIUM-FLUORESCENCE.mat
    ...
    # 那么，执行 __parser_subcommand = kwargs.pop('subcommand') 之后，__parser_subcommand的值将会是'detection'，而kwargs将变为{'input-file': 'myfile.txt'}
